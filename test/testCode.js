...
function onOpen() {
  ...
  var menuEntries = [
    { name: "Salvar esta Planilha", functionName: "exportSheet" },
    { name: "Salvar todas Planilhas", functionName: "exportAllSheets" }
  ];
  ss.addMenu("SALVAR NO BANCO", menuEntries);
}
...
function exportSheet(e) {
  ...
  var jsonObj = makeJSON_({
    "token": "NCperF1UsxE1NSSZ3sARoCg8lXcUFMb8",
    "data": json
  }, getExportOptions(e));

  //displayText_(json);

  var url = "http://chave-mestra.net/api/ifood/index.php";
  var options = {
    "method": "post",
    "headers": {
  ...
  //{"token":"NCperF1UsxE1NSSZ3sARoCg8lXcUFMb8", "data":json}
  //var response = UrlFetchApp.fetch(url, options);
  var response = UrlFetchApp.fetch(url, options);

  displayText_(response);
}
...
function displayText_(text) {
  ...
  SpreadsheetApp.getUi()
    .showModalDialog(output, 'Resposta do Servidor');
}
